...
% will create the vertex trait 'normal', set the normal of the first vertex
...
% All tasks in Assignment 1 are possible without using looping over all
% elements in the mesh. Although for some tasks you have to get creative
% in order to do that :)